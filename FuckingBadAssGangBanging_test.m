...
% %load('data2')
% load([ScriptDir,'\..\Results\archiveNew.mat'])
% n_archive=1%size(init,2);
...
SimData(n_archive).SDi=[]; 
SimDataElite(n_archive).SDi=SDi_new; 
% 
%  save([ScriptDir,'\..\Results\archiveWithLHC.mat'],'archive','init','F_archive','F_total','P_total','number_of_ND','SimData','SimDataElite','F_min','F_max')
